...
#create_clock -add -name clk_pin -period 20.00 -waveform {0 10} [get_ports { i_clk }];
...
set_property -dict { PACKAGE_PIN H18   IOSTANDARD LVCMOS33 } [get_ports {o_leds[2]}];
...
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS33 } [get_ports {o_leds[0]}]; 
...
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports {o_leds[1]}]; 
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports {o_div_clk}]; 
...
##DAUGHTER BOARD KEYS
#set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports {i_key[1]}];
#set_property -dict { PACKAGE_PIN T19   IOSTANDARD LVCMOS33 } [get_ports {i_key[0]}];
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports {i_key[2]}];
